  ...
  methods: {
    ...
    drawRadialAreaChart(map) {
      let data = [[
        ...
        {
          date: 10,
          avg: 16.333333333333332,
          min: 20,
          max: 35.85,
        },
        {
          date: 11,
          avg: 18.583333333333332,
          min: 23.05,
          max: 36.35,
        },
        {
        ...
        {
          date: 12,
          avg: 14.583333333333332,
          min: 17.35,
          max: 31.85,
        },
        {
          date: 13,
          avg: 12.583333333333332,
          min: 16.5,
          max: 28.35,
        },
        {
